...
//   {
//     image: "Good",
//     text: "How do you define success and how do you measure up to your own defination ?",
//   },
 
//   {
//     image: "tellme",
//     text: "Do you have any question for me ",
//   },
...
// //     <img src='https://github.com/UmendraBisen2/images/${image}.jpg?raw=true' alt="${text}"/>
// //    `;
// //   //   <p class="info">${text}</p>
...
//     // <p class="info">${text}</p>
//     // `;
//   box.addEventListener("click", () => handleSpeech(text, box));https://github.com/bradtraversy/vanillawebprojects/tree/master/speech-text-reader/img
...
function createBox(item) {
  ...
  box.classList.add("box");
   box.innerHTML = `
    <img src=' https://github.com/UmendraBisen2/Photos-/blob/main/businesswoman-listening-interested.jpg?raw=true' alt="${text}"/> 
    <p class="info">${text}</p>
    `; 
